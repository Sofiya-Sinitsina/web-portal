...
const lakes = ref<Lake[]>([
  ...
  { name: 'Озеро Паганка', lat: 54.823782, lng: 69.146870, level: 1365 },
  { name: 'Малое Белое', lat: 54.950006, lng: 69.325277, level: 1098 },
  { name: 'Озеро Солёное', lat: 54.806861, lng: 69.140929, level: 1145},
])
</script>